import type { InventoryItem, InventoryMovement, OrderFee, OrderItem, OrderView, Shipment, Transaction } from "./types";
...
export const demoInventory: InventoryItem[] = [
  {
    ...
    upc: "645397938446",
    sku: "CH-SHR-6",
    partner_item_id: "645E-11",
    partner_gtin: "645397938446",
    product_name: "Skeeter Hawk Repellent",
    brand: "Skeeter Hawk",
    category: "Home & Outdoor",
    product_type: "Repellent",
    contract_category: "Home & Pest",
    fulfillment_type: "Walmart Fulfillment (WFS)",
    marketplace: "Walmart",
    ...
    updated_at: "2026-05-15T14:24:00.000Z",
    last_scanned_at: "2026-05-15T14:24:00.000Z",
  },
  {
    id: "inv-2",
    upc: "712345678901",
    sku: "CH-MWB",
    partner_gtin: "712345678901",
...
export const demoMovements: InventoryMovement[] = [
  {
    ...
    quantity_change: -6,
    reason: "Sale",
    source: "System: Order #200014533145443",
    source_order_id: "ord-1",
    source_order_number: "200014533145443",
    source_po_number: "119113696422784",
    created_by: "System",
    created_at: "2026-05-15T14:24:00.000Z",
  },
  {
    id: "mov-2",
    inventory_item_id: "inv-1",
    ...
    source: "Barcode Scan",
    created_by: "Admin",
    created_at: "2026-05-12T20:31:00.000Z",
  },
  {
    id: "mov-3",
    inventory_item_id: "inv-1",
    ...
    source: "Admin",
    created_by: "Admin",
    created_at: "2026-05-07T15:02:00.000Z",
  },
  {
    id: "mov-4",
    inventory_item_id: "inv-1",
    ...
    source: "Admin",
    created_by: "Admin",
    created_at: "2026-05-06T19:45:00.000Z",
  },
  {
    id: "mov-5",
    ...
    quantity_change: -2,
    reason: "Sale",
    source: "System: Order #200014532998877",
    source_order_id: "ord-2",
    source_order_number: "200014532998877",
    source_po_number: "119113695112233",
    created_by: "System",
    created_at: "2026-05-14T11:12:00.000Z",
  },
];
